...
export default function Results() {
  ...
  const validateAccess = async () => {
    try {
      ...
      const sessionDataStr = sessionStorage.getItem("registrationSession")
      if (!sessionDataStr) {
        setAccessDenied(true)
        setIsValidating(false)
        return
      ...
      if (Date.now() > sessionData.expires) {
        sessionStorage.removeItem("registrationSession")
        setAccessDenied(true)
        setIsValidating(false)
        return
      }
      ...
      try {
        const response = await apiRequest("POST", "/api/validate-session", {
          token: tokenFromUrl
        })
        ...
        // Session is valid - set owner name and invalidate the token
  ...
  const handleWhatsAppContact = () => {
    const message = encodeURIComponent(
      `Hi! I just submitted a vehicle registration and would like to get in touch regarding my application. Name: ${ownerName}`
    )
          ...
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-xl text-gray-600 mb-6">
                This page can only be accessed after successfully submitting a registration form
              </p>
            </div>
                ...
                <div className="text-center space-y-6">
                  <div className="bg-red-50 border border-red-200 rounded-lg p-6">
                    ...
                    <p className="text-red-700 leading-relaxed">
                      The results page can only be accessed immediately after submitting a registration form. 
      ...
      <div className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 mb-6">
              Your vehicle registration has been submitted successfully
            </p>
          </div>
              ...
              <div className="text-center space-y-6">
                ...
                <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                  ...
                  <p className="text-green-700 leading-relaxed">
                    Please wait while we process your application. We will review your registration 
                    and notify you within <strong>one business day</strong> with the next steps.
                  </p>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mt-6">
                  ...
                  <ul className="text-blue-700 text-sm space-y-2 text-left">
                    ...
                    <li>• Have your vehicle documents ready if requested</li>
                    <li>• Registration reference will be sent to your contact number</li>
                  </ul>
                </div>
              </div>
            </CardContent>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-gray-500">
              Thank you for choosing our vehicle registration service
            </p>
          </div>
        </div>
      </div>
